...
const Robotic = () => (
  <div className="service-modal-card">
    <div><img src="/static/img/services/robotica.jpg" alt=""/></div>
    
    <div className="title">ROBÓTICA SUBMARINA</div>
    <div className="description">Ante la necesidad de verificar y registrar el estado del fondo marino o estructuras sumergidas para proyectos de ingeniería costera y medio ambientales, Nazca Spa. se ha implementado con ROVs de última generación que tienen integrada su posición GPS mediante la modalidad USBL y con la capacidad de filmar hasta 180 metros de profundidad.</div>
  </div>
);
